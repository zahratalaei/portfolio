          ...
          >
               <div className="z-10 mt-32 md:basis-3/5">
                    ...
                    >
                         ...
                         <p className='text-md py-5 text-gray-800 leading-8 md:text-xl md:px-2 max-w-3xl  dark:text-gray-200 tracking-wide '>Hello! I'm a dedicated web developer with over six years of practical experience in the field, based in Brisbane, Australia. I come from a theoretical and computational physics background, which has instilled in me a deep love for problem-solving and tackling intricate tasks. Whether working solo or collaborating as part of a team, my approach to web development is marked by meticulous attention to detail, robust technical knowledge, and a relentless pursuit of innovative solutions.
                         </p>
