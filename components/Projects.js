...
const Projects = () => {
  return (
   ...
   <div className='md:grid md:grid-cols-2 gap-10'>
     ...
     {/* <div className='text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white flex-1'>
       <Image src={lfl}/>
       <h3 className='text-lg font-medium pt-8 pb-2'>Life Flight Lottery Blog</h3>
       <p className='py-2'> Creating The blog for Life Flight Lottery website. It is a Custom Theme made from the scratch.</p>
     ...
     <div className='text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white flex-1'>
       ...
       <p className='py-2'>Through this application you can find the latest popular movies in home page and search the movie by it's name among all the movies in TMDB API. By click on each movie you have access to the details of it. You also be able to paginate through the different pages. All the data comes from TMDB API.</p>
     ...
     <div className='text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white flex-1'>
       ...
       <p className='py-2'>This the blog of Your Hospice Lottery website. It's a Wordpress custom theme created from the scratch.</p>
       <p className='text-gray-800 py-1 mt-4'><span className='text-teal-600 py-4 font-bold'>Used Technologies: </span>Wordpress, PHP, bootstrap</p>
     </div>
     <div className='text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white flex-1'>
       ...
       <p className='py-2'>It is a Full Stack Blog App. Being able to see, add comments and likes the posts you need to have an account and sing in to the app. Only post's author can edit/delete the post. </p>
